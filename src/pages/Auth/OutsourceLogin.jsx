...
import "./OutsourceLogin.css";

const OutsourceLogin = () => {
  ...
  const defaultUsers = [
    { email: "outsource@ems.com", password: "outsource123", role: "Outsource" },
  ];
